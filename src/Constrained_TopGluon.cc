//
// $Id: Constrained_TopGluon.cc,v 1.3 2012/02/03 06:47:33 ymtzeng Exp $
//
// File: src/Constrained_TopGluon.cc
// Purpose: Do kinematic fitting for a ttbar -> ljets event.
// Created: Jul, 2000, sss, based on run 1 mass analysis code.
//
// CMSSW File      : src/Constrained_TopGluon.cc
...
Constrained_TopGluon_Args::Constrained_TopGluon_Args (const Defaults& defs)
//
// Purpose: Constructor.
//
// Inputs:
...
double Constrained_TopGluon_Args::bmass () const
//
...
Constrained_TopGluon_Args::fourvec_constrainer_args () const
//
...
bool Constrained_TopGluon_Args::equal_side () const
//
...
Constrained_TopGluon::Constrained_TopGluon (const Constrained_TopGluon_Args& args,
                                  double lepw_mass,
                                  double hadw_mass,
                                  double top_mass)
//
    ...
    _constrainer (args.fourvec_constrainer_args())
{
  ...
  if (args.equal_side()) {
      ...
      std::cout<<"equal_side : "<<buf<<std::endl;
      _constrainer.add_constraint (buf);
  }
...
double Constrained_TopGluon::constrain (Lepjets_Event& ev,
                                   double& mt,
                                   double& sigmt,
                                   Column_Vector& pullx,
                                   Column_Vector& pully)
...
/**
    @brief Output stream operator, print the content of this Constrained_TopGluon
    object to an output stream.

    @param s The output stream to which to write.

    @param ct The instance of Constrained_TopGluon to be printed.

*/
std::ostream& operator<< (std::ostream& s, const Constrained_TopGluon& ct)
//
