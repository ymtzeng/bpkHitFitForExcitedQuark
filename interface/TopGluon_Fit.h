//
// $Id: TopGluon_Fit.h,v 1.2 2012/02/03 06:46:30 ymtzeng Exp $
//
// File: hitfit/TopGluon_Fit.h
// Purpose: Handle jet permutations.
// Created: Jul, 2000, sss, based on run 1 mass analysis code.
//
// CMSSW File      : interface/TopGluon_Fit.h
...
/**
    @brief Hold on to parameters for the TopGluon_Fit class.
*/
class TopGluon_Fit_Args
//
// Purpose: Hold on to parameters for the TopGluon_Fit class.
//
...
public:
  ...
  /**
     @brief Constructor, initialize an instance of TopGluon_Fit_Args
   ...
   */
  TopGluon_Fit_Args (const Defaults& defs);
  ...
  const Constrained_TopGluon_Args& constrainer_args () const;
...
private:
  ...
  /**
     ...
     within an instance of TopGluon_Fit.
   */
  Constrained_TopGluon_Args _args;
...
public:
   ...
   */
  TopGluon_Fit (const TopGluon_Fit_Args& args,
           double lepw_mass,
           double hadw_mass,
           double top_mass);
  ...
  // Print.
  friend std::ostream& operator<< (std::ostream& s, const TopGluon_Fit& fitter);

  /**
     @brief Return a constant reference to the fit arguments.
   */
  const TopGluon_Fit_Args& args() const;

private:
  // The object state.
  const TopGluon_Fit_Args _args;
  Constrained_TopGluon _constrainer;
  double _lepw_mass;
  double _hadw_mass;
};
