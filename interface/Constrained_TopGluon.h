//
// $Id: Constrained_TopGluon.h,v 1.1 2012/02/02 21:31:50 ymtzeng Exp $
//
// File: hitfit/Constrained_TopGluon.h
// Purpose: Do kinematic fitting for a ttbar -> ljets event.
// Created: Jul, 2000, sss, based on run 1 mass analysis code.
//
// CMSSW File      : interface/Constrained_TopGluon.h
// Original Author : Scott Stuart Snyder <snyder@bnl.gov> for D0
// Imported to CMSSW by Haryo Sumowidagdo <Suharyo.Sumowidagdo@cern.ch>


/**
    @file Constrained_TopGluon.h
...
/**
    ...
    @class Constrained_TopGluon_Args

    @brief Hold on to parameters for the Constrained_TopGluon class.

 */
class Constrained_TopGluon_Args
//
// Purpose: Hold on to parameters for the Constrained_TopGluon class.
//
...
public:
   ...
   */
  Constrained_TopGluon_Args (const Defaults& defs);
...
public:
  ...
  // set the mass to 0.
  /**
     @brief Constructor, create an instance of the Constrained_TopGluon object
     from the arguments object and the mass constraints.

     @param args Argument for this instance of Constrained_TopGluon object.
   ...
   */
  Constrained_TopGluon (const Constrained_TopGluon_Args& args,
                   double lepw_mass,
                   double hadw_mass,
                   double top_mass);
  ...
  // Dump out our state.
  friend std::ostream& operator<< (std::ostream& s, const Constrained_TopGluon& ct);
...
private:
   ...
   */
  const Constrained_TopGluon_Args _args;
